...
### Creating a Custom Page (e.g., Example Page)

If you want a page accessible at:

_http://localhost:3000/example_

Follow the same steps as above:

1. Inside _src/app_, create a folder named _example_.
2. Inside _example_, create a _page.tsx_ file.
3. Add the following code:

```tsx
export default function Example() {
  return <h1>Hello from Example</h1>;
}
```
