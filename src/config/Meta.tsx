...
export const siteConfig = {
  ...
  title: 'Debangshu Chatterjee | GenAI & Full Stack Developer',
  description: 'Portfolio of Debangshu Chatterjee - GenAI & Full Stack Developer specializing in Python, Deep Learning, LLMs, and Next.js. SIH 2024 Runner Up | Infosys Global AIR 8 | IEEE YESIST12 Top 3.',
  url: process.env.NEXT_PUBLIC_URL || 'https://www.debangshu.tech/',
